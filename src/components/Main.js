            ...
            <div className="container m-5">
                ...
                <div className="row">
                    <ul className="col-12 col-xxl-6 list-group mt-5 ps-4">
                        ...
                        <li className="list-group-item"><span className="fw-bold">Full Name: Mokshith Telugu </span></li>
                        <li className="list-group-item"><span className="fw-bold">Birthday: 19th December  </span></li>
                        <li className="list-group-item"><span className="fw-bold">City: Gadhwal</span></li>
                    </ul>
                    <ul className="col-12 col-xxl-6 list-group mt-5 pe-4">
                        <li className="list-group-item"><span className="fw-bold">Git Profile: </span><a className="link" href="https://github.com/mokshithtelugu">Click Here</a></li>
